...
# modular_spaceflights documentation build
...
from modular_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "modular_spaceflights"
...
htmlhelp_basename = "modular_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "modular_spaceflights.tex",
        "modular_spaceflights Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "modular_spaceflights",
        "Project modular_spaceflights codebase.",
        "Data-Science",
    )
]
